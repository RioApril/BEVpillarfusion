...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        score_thr=0.3,
        test_out_dir=
        '/home/vipuser/project/mmdetection3d/kitti_predictions_pointpillars/vis_data',
...
launcher = 'none'
load_from = '/home/vipuser/project/mmdetection3d/work_dirs/final_result/pointpillars/epoch_60.pth'
log_level = 'INFO'
            ...
            pipeline=[
                ...
                dict(
                    db_sampler=dict(
                        ...
                        data_root='data/view_of_delft_PUBLIC/radar_3frames/',
                        info_path=
                        'data/view_of_delft_PUBLIC/radar_3frames/kitti_dbinfos_train.pkl',
                        points_loader=dict(
                            backend_args=None,
                            coord_type='LIDAR',
                            load_dim=7,
...
work_dir = '/home/vipuser/project/mmdetection3d/kitti_predictions_pointpillars'
