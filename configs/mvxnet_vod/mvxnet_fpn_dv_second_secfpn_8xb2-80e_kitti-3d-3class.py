...
val_evaluator = dict(
    type='VODMetric', ann_file='data/view_of_delft_PUBLIC/radar_3frames/kitti_infos_val.pkl')
...
load_from = '~/project/mmdetection3d/work_dirs/mvxnet_fpn_dv_second_secfpn_8xb2-80e_kitti-3d-3class/epoch_40.pth'
