...
class CenterHead(BaseModule):
    ...
    def get_targets_single(self,
        ...
        gt_annotation_num = len(self.train_cfg['code_weights']) # from centerpoint kitti pr, by zrx
        ...
        for idx, task_head in enumerate(self.task_heads):
            ...
            # anno_box = gt_bboxes_3d.new_zeros((max_objs, 10),
                                            #   dtype=torch.float32)  # commented out by zrx
            ...
            for k in range(num_objs):
                ...
                if width > 0 and length > 0:
                    ...
                    # vx, vy = task_boxes[idx][k][7:] # commented out by zrx
                    ...
                    #     torch.cos(rot).unsqueeze(0),
                        # vx.unsqueeze(0),
                        # vy.unsqueeze(0)          # commented out by zrx
                        # ])
                    anno_elems = [
                        center - torch.tensor([x, y], device=device),
                        z.unsqueeze(0), box_dim,
    ...
    def loss_by_feat(self, preds_dicts: Tuple[List[dict]],
        ...
        for task_id, preds_dict in enumerate(preds_dicts):
            ...
            # print('target_box_size:', target_box.size())
